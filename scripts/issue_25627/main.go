...
/*
func TestExampleWebApplicationFirewallPoliciesClient_CreateOrUpdate(t *testing.T) {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	ctx := context.Background()
	clientFactory, err := armnetwork.NewClientFactory("4d042dc6-fe17-4698-a23f-ec6a8d1e98f4", cred, &arm.ClientOptions{
	...
	res, err := clientFactory.NewWebApplicationFirewallPoliciesClient().CreateOrUpdate(ctx, "judytest", "Policy1", armnetwork.WebApplicationFirewallPolicy{
